      ...
      <nav className="navbar navbar-expand-lg p-4">
        <div className="container-fluid">
          <a className="navbar-brand" href="#">
            ...
            <span className="fw-bold">Sundaram ForexCard</span>
          </a>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item ms-lg-3"><a className="btn btn-outline-light" href="/login">Login</a></li>
              <li className="nav-item ms-lg-2"><a className="btn btn-light text-primary" href="/register">Register</a></li>
            </ul>
          </div>
        </div>
      </nav>
